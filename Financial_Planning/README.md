...
* [Personal Finance Planner Completed Code](Financial_Planning/financial-planner.ipynb)

* [MCForecastTools toolkit](Financial_Planning/MCForecastTools.py)
...
To develop the personal finance planner prototype, we should take into account the following assumptions:
